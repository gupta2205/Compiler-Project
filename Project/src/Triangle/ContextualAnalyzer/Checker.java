...
public final class Checker implements Visitor {
  ...
  public Object visitAssignCommand2(AssignCommand2 ast, Object o) {
		TypeDenoter vType = (TypeDenoter) ast.V.visit(this, null);
		TypeDenoter ceType = (TypeDenoter) ast.CE.visit(this, null);
		if(!ast.V.variable)
			reporter.reportError("LHS of assignment is not a variable", "", ast.V.position);
		if(!ceType.equals(vType))
			reporter.reportError("assignment imcompatibility", "", ast.position);
		return null;
	}
  ...
  public Object visitCaseCommand(CaseCommand ast, Object o) {	
		...
		LinkedHashMap<IntegerLiteral, Command> CASELIST = ast.CASELIST;
		ArrayList<IntegerLiteral> AL = new ArrayList<IntegerLiteral>();
		for(IntegerLiteral IL : CASELIST.keySet()){
  ...
  //	added for problem 9.8		@authors:-	megha & nikhil
  public Object visitVarDeclarationAssignment(Var_Declaration_Assignment ast,
			Object o) {
	  TypeDenoter eType = (TypeDenoter) ast.E.visit(this, null);
	    ast.T = eType;
	    idTable.enter (ast.I.spelling, ast);
  ...
  public Object visitSimpleVname(SimpleVname ast, Object o) {
    ...
    if (binding == null)
      ...
      if (binding instanceof ConstDeclaration) {
        ...
        ast.variable = true;
      } else if (binding instanceof Var_Declaration_Assignment) {
          //TODO: Check this is right
          ast.type = ((Var_Declaration_Assignment) binding).T;
          ast.variable = true;
  ...
  private void establishStdEnvironment () {
    ...
    //added for 9.12
    StdEnvironment.lexicalDecl = declareStdBinaryOp("<<", StdEnvironment.anyType, StdEnvironment.anyType, StdEnvironment.booleanType);
    
    //added for 9.15
    StdEnvironment.rgcDecl = declareStdProc("rgcDecl", new EmptyFormalParameterSequence(dummyPos));
  }
}

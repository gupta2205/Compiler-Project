...
public final class Encoder implements Visitor {
  ...
  public Object visitAssignCommand2(AssignCommand2 ast, Object o) {
		Frame frame = (Frame) o;
		Integer valSize = (Integer) ast.CE.visit(this, frame);
  ...
  // added for part 9.6b
    ...
    public Object visitForCommand(ForCommand ast, Object o) {
      ...
      jumpAddr = nextInstrAddr;
      emit(Machine.JUMPop, 0, Machine.CBr, jumpAddr);
      loopAddr = nextInstrAddr;
      //emit(Machine.LOADop, 1, Machine.STr, -2);
      ast.C.visit(this, frame);
      emit(Machine.LOADop, 1, Machine.STr, -2);
//LBR here if changing back
...
/**/
  ...
  public Object visitCaseCommand(CaseCommand ast, Object o) {		
		...
		for(IntegerLiteral IL : ast.CASELIST.keySet()){
			ast.E.visit(this, frame);
			...
			ast.CASELIST.get(IL).visit(this, frame);
			emit(Machine.LOADLop, 0, 0, 1);
  ...
  public Object visitSubscriptVname(SubscriptVname ast, Object o) {
    ...
    ast.indexed = ast.V.indexed;
    // added for 9.15
    int upperBound =Integer.parseInt((((ArrayTypeDenoter)ast.V.type).IL.spelling))-1;
    ...
    if (ast.E instanceof IntegerExpression) {
      ...
      emit(Machine.LOADLop, 0,0,0+((KnownAddress)baseObject).address.displacement);
      emit(Machine.LOADLop,0,0,upperBound+((KnownAddress)baseObject).address.displacement);
      emit(Machine.CALLop,Machine.SBr,Machine.PBr,Machine.rgcDisplacement);
  ...
  public Object visitSubscriptVname2(SubscriptVname2 ast, Object o) {
	    ...
	    ast.indexed = ast.V.indexed;
	    elemSize = ((Integer) ast.type.visit(this, null)).intValue();
	    ast.offset = ast.offset + Integer.parseInt(ast.IL.spelling) * elemSize;
	    return baseObject;
	}
...
//   	  emit(Machine.LOADLop,0,0,address.displacement-1);
//   	  emit(Machine.CALLop, Machine.SBr, Machine.PBr, Machine.rgcDisplacement);
    } else if (baseObject instanceof UnknownAddress) {
      ObjectAddress address = ((UnknownAddress) baseObject).address;
      emit(Machine.LOADop, Machine.addressSize, displayRegister(frame.level,
  ...
  public Object visitVarDeclarationAssignment(Var_Declaration_Assignment ast, Object o){
    Frame frame = (Frame) o;
    int extraSize = 0;
    
    TypeDenoter type = ast.E.type;
    extraSize = ((Integer) ast.T.visit(this, null)).intValue(); 
    emit(Machine.PUSHop, 0, 0, extraSize);
